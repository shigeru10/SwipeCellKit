...
public protocol SwipeCollectionViewCellDelegate: class {
    ...
    /**
     ...
     - returns: A `SwipeCollectionOptions` instance which configures the behavior of the action buttons.
     
     - note: If not implemented, a default `SwipeCollectionOptions` instance is used.
     */
    func collectionView(_ collectionView: UICollectionView, editActionsOptionsForRowAt indexPath: IndexPath, for orientation: SwipeActionsOrientation) -> SwipeCollectionOptions
